...
static PRODUCT_TAG: Lazy<String> = Lazy::new(|| "AutoMate BAS Studio v2".to_string());
...
impl AutoMateApp {
    ...
    fn render_titlebar_contents(&mut self, ui: &mut Ui) {
        ...
        ui.horizontal(|ui| {
            ui.label(
                RichText::new("AutoMate BAS Studio v2")
    ...
    fn dialogs(&mut self, ctx: &egui::Context) {
        if self.show_about {
            egui::Window::new("About")
                ...
                .show(ctx, |ui| {
                    ui.label("AutoMate BAS Studio v2");
